...
Route::prefix('customer')
    ...
    ->group(function () {
        ...
        Route::post('/verify', [OtpController::class, 'verify'])->middleware('throttle:5,1')->name('verify.otp');

        Route::get('/resend-otp', [OtpController::class, 'resend'])->middleware('throttle:3,1')->name('resend-otp');
