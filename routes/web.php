...
use App\Http\Controllers\Owner\RedemptionCatalogController as OwnerRedemptionCatalogController;
use App\Http\Controllers\Owner\RedemptionClaimController as OwnerRedemptionClaimController;
...
Route::prefix('owner')
    ...
    Route::middleware(['role:owner'])->group(function () {
        ...
        // Katalog item tukar poin (owner atur nama, deskripsi, & berapa poin yang dibutuhkan)
        Route::get('/redemptions', [OwnerRedemptionCatalogController::class, 'index'])->name('redemptions.index');
        Route::get('/redemptions/create', [OwnerRedemptionCatalogController::class, 'create'])->name('redemptions.create');
        Route::post('/redemptions', [OwnerRedemptionCatalogController::class, 'store'])->name('redemptions.store');
        Route::get('/redemptions/{redemption}/edit', [OwnerRedemptionCatalogController::class, 'edit'])->name('redemptions.edit');
        Route::put('/redemptions/{redemption}', [OwnerRedemptionCatalogController::class, 'update'])->name('redemptions.update');
        Route::patch('/redemptions/{redemption}/toggle-active', [OwnerRedemptionCatalogController::class, 'toggleActive'])->name('redemptions.toggle-active');
        Route::delete('/redemptions/{redemption}', [OwnerRedemptionCatalogController::class, 'destroy'])->name('redemptions.destroy');
