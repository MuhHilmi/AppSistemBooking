<section class="relative overflow-hidden py-24">
    ...
    <div class="container-custom relative z-10">
        ...
        <div
            ...
            {{-- Heading --}}
            <h2
                class="mt-6 text-4xl font-extrabold leading-tight text-white lg:text-5xl">
            ...
            <p
                ...
                Temukan berbagai pilihan lapangan olahraga dengan jadwal
                yang selalu diperbarui secara real-time.
                Booking kapan saja, di mana saja, dengan proses yang cepat,
                aman, dan nyaman.
            ...
            {{-- Bottom Feature --}}
            <div
                class="mt-12 grid gap-6 text-sm text-green-100 sm:grid-cols-3">
