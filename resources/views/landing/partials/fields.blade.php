<section id="fields" class="bg-slate-50 py-24">
    <div class="container-custom">
        ...
        <div class="mx-auto max-w-3xl text-center">
            ...
            >Pilih berbagai jenis lapangan olahraga dengan jadwal yang selalu diperbarui secara real-time.</p>
        </div>
                ...
                >
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            <span class="text-yellow-500"> ⭐ {{ $field['rating'] }} </span>

                            <span class="text-slate-500"> 📍 {{ $field['city'] }} </span>
                        </div>
