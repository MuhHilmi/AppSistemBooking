    ...
    <div class="container-custom py-20">
        ...
        <div class="grid gap-12 lg:grid-cols-5">
            ...
            <div class="lg:col-span-2">
                ...
                <p class="mt-6 max-w-md leading-8 text-slate-400">

                    Platform booking lapangan olahraga yang membantu pelanggan
                    menemukan, membandingkan, dan memesan lapangan secara online
                    dengan proses yang cepat, mudah, dan aman.
        ...
        {{-- Bottom --}}
        <div
            class="flex flex-col items-center justify-between gap-6 text-sm md:flex-row">
