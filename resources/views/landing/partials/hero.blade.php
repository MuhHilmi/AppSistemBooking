<section id="hero" class="relative overflow-hidden">
    ...
    {{-- Background --}}
    <div class="absolute inset-0 bg-gradient-to-br from-green-50 via-white to-emerald-100 -z-20"></div>

    {{-- Decorative Blur --}}
    <div class="absolute -top-32 -left-20 h-96 w-96 rounded-full bg-green-300/20 blur-3xl -z-10"></div>

    <div class="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-emerald-400/20 blur-3xl -z-10"></div>
    ...
    <div class="container-custom">
        ...
        <div class="grid items-center gap-16 lg:grid-cols-2 min-h-[90vh]">
            ...
            <div>
                ...
                <h1
                    class="mt-6 text-5xl font-black leading-tight text-slate-900 lg:text-7xl">
                ...
                <p
                    ...
                    Temukan lapangan futsal, badminton, basket,
                    tenis, dan berbagai olahraga lainnya.
                    Pilih jadwal yang tersedia, lakukan pembayaran,
                    dan nikmati pengalaman booking yang cepat,
                    aman, dan praktis.
            ...
            <div class="relative">
                ...
                {{-- Main Mockup --}}
                <div
                    class="overflow-hidden rounded-3xl border border-white/60 bg-white shadow-2xl">
                ...
                {{-- Floating Card 1 --}}
                <div
                    class="absolute -left-8 top-12 rounded-2xl bg-white p-5 shadow-xl">
                ...
                {{-- Floating Card 2 --}}
                <div
                    class="absolute -right-6 bottom-12 rounded-2xl bg-white p-5 shadow-xl">
