    ...
    <div class="container-custom">
        ...
        <div class="mx-auto max-w-3xl text-center">
            ...
            <p
                ...
                Kami menghadirkan pengalaman booking lapangan yang lebih cepat,
                transparan, dan nyaman untuk pelanggan maupun pemilik tempat usaha.
        ...
        {{-- Main Feature --}}
        <div
            class="mt-20 grid items-center gap-16 lg:grid-cols-2">
            ...
            <div>
                ...
                <p
                    ...
                    Platform kami dirancang untuk memberikan pengalaman
                    booking yang sederhana namun tetap lengkap, baik
                    bagi pelanggan maupun pengelola lapangan.
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-600">
                                ...
                                Ketersediaan lapangan selalu diperbarui secara langsung.
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-600">
                                ...
                                Pesan lapangan kapan saja tanpa harus datang langsung.
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-600">
                                ...
                                Mendukung berbagai metode pembayaran dengan proses yang aman.
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-600">
                                ...
                                Semua transaksi tersimpan sehingga mudah dilihat kembali.
        ...
        {{-- Feature Grid --}}
        <div
            class="mt-24 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
