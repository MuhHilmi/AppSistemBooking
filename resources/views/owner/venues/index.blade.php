    ...
    @if($venues->count())
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            @foreach($venues as $venue)
                ...
                <div class="overflow-hidden rounded-xl bg-white shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-xl">

                    {{-- Gambar --}}
                    <img src="{{ 'storage/'.$venue->photo ?? 'https://via.placeholder.com/600x300' }}"
