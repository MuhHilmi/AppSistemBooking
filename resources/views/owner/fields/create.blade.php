...
<div class="max-w-5xl mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('fields.index') }}" class="px-5 py-2 rounded-lg border border-gray-300 hover:bg-gray-200 transition">
            Kembali
        </a>
    </div>
            ...
            <div class="lg:col-span-2 bg-white rounded-xl shadow p-6">
                <div class="grid md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <select
                            name="status"
                            class="w-full border rounded-lg mt-2 p-3">
                            <option value="1" @selected(old('status') == "1")>
                                Aktif
                            </option>
                ...
                <div class="mt-6">
                    ...
                    <textarea
                        name="description"
                        rows="6"
                        class="w-full border rounded-lg mt-2 p-3">{{ old('description') }}</textarea>
                </div>
            </div>
