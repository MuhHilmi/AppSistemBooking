...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        @if($field->thumbnail)
            <img src="{{ asset('storage/' . $field->thumbnail) }}" alt="{{ $field->name }}" class="w-full h-64 object-cover">
        @else
        ...
        <div class="p-6">
            ...
            <div class="mt-6 flex gap-4">
                <a href="{{ route('fields.index') }}" class="inline-block bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">
                    Kembali
                </a>
                <a href="{{ route('fields.edit', $field->id) }}" class="inline-block bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">
                    Edit
                </a>
            </div>
        </div>
