            ...
            <div class="lg:col-span-2 bg-white rounded-xl shadow p-6">
                <div class="grid md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option
                                value="1"
                                @selected(old('status', $field->status) == 1)>
                                Aktif
                            </option>
                            <option
                                value="0"
                                @selected(old('status', $field->status) == 0)>
                                Nonaktif
                            </option>
                        </select>
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea
                        name="description"
                        rows="6"
                        class="w-full border rounded-lg mt-2 p-3">{{ old('description', $field->description) }}</textarea>
                </div>
            </div>
